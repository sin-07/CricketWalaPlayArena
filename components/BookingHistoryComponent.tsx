...
const BookingHistoryComponent: React.FC<BookingHistoryProps> = ({ phone, email }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full"
    >
      <Card className="border-primary-200 shadow-md w-full">
        <CardHeader className="pb-3 px-4 md:px-6">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base md:text-lg flex items-center">
              <History className="w-4 h-4 md:w-5 md:h-5 mr-2 text-primary-600" />
        ...
        <CardContent className="px-4 md:px-6">
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-3 mb-4">
            ...
            <div className="bg-purple-50 rounded-lg p-2 md:p-3 text-center">
              <div className="text-xl md:text-2xl font-bold text-purple-600">{stats.completed}</div>
